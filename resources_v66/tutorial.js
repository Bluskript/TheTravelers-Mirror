var TUT = {
    ...
    go: function (new_state) {
        let rightmove = document.getElementById("right-movement-box"),
        ...
        if (new_state === -1) { // no tutorial, show everything normally
            ...
            switch (new_state) {
                ...
                case 1: {
                    ...
                    for (let i = 0; i < WORLD.otherObjs.length; i++) {
                        if (WORLD.otherObjs[i].char === "u") {
                            ...
                            if (YOU.x === oX && oY > YOU.y) {
                                dir = "down";
                            } else if (YOU.y === oY & oX > YOU.x) {
                                dir = "left";
                            } else if (YOU.y === oY & oX < YOU.x) {
                                dir = "right";
                            }

                            TUT.boxAtId(new_state, id, 90, dir, "there's something here. use the arrow keys to walk to it and investigate.");
                            break;
                        }
                    }
                    break;
                ...
                case 4: {
                    // explain the tracker
                    TUT.boxAtId(new_state, "world-position", 165, "top",
                ...
                case 5: {
                    // show the stats menu
                    TUT.fadeIn(youMenu.id);
                    TUT.boxAtEl(new_state, youMenu, 150, MOBILE.is ? "down" : "left",
                        "your personal statistics are shown here. leveling up will earn skill points which can be used to upgrade your stats. death carries a heavy toll.",
                        "TUT.update()");
                    break;
                }
                case 6: {
                    ...
                    TUT.boxAtEl(new_state, craftMenu, 180, MOBILE.is ? "down" : "right",
                        "craft items to help assist you in your travels. every ten levels, you will be able to craft new items. you can find blueprints that teach you to craft certain rare items as well.",
                        "TUT.update()");
                    break;
                }
                case 7: {
