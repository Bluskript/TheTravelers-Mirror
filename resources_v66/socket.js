var SOCKET = {
    conn: $.connection.logHub,  //freakin signalr won't let you rename any of its classes so i can't make it something normal like "socket" or "conn"
    hub: $.connection.hub,      //but signalr is a great library so whatever man it can do what it wants
    isOpen: false,
    open: function () {
        SOCKET.close();
        this.conn.client.getGameObject = function (json) {
            ENGINE.applyData(json);
        };
        this.conn.client.getGameObjectNoCountdown = function (json) {
            ENGINE.applyData(json, true);
        };
        this.conn.client.raw = function (js) {
            eval(js); // :^)
        };
    ...
    send: function (job) {
        SOCKET.conn.server.fromClient(job);
    },
    ...
    login: function () {
        ...
        let badlogin = document.getElementById("badlogin"),
            ...
            failed = function () {
                ...
                badlogin.innerHTML = "bad credentials";
    ...
    autolog: function () {
        ...
        document.getElementById("main-content-dip").style.height = "450px";
        ...
        let tips = [
            ...
            "activating your camo before logging off will make you invisible unless another traveler is within 5km.",
            "when digging at any location, there's about a 5% chance of getting scrap, 3% chance of getting steel, and 2% chance of getting copper.",
            ...
            "the lack of uppercase letters throughout the game is an homage the text-based adventure \"a dark room\".",
            ...
            "houses expire and regenerate loot after 5 real days, and cities regenerate after 20 real days. traveling is always a more efficient way to gain loot.",
            ...
            "if you see the button \"leave\" when at a location, it will always immediately end the event. if you don't see it, you're forced to make a choice."
        ];
